...
combinar_asm:
	...
	.ciclo:
		...
		pmulld xmm1, xmm0		; xmm1 = | (px0_a - px0_b) * alpha |
		pmulld xmm4, xmm0		; xmm4 = | (px1_a - px1_b) * alpha |
		pmulld xmm3, xmm0		; xmm3 = | (px2_a - px2_b) * alpha |
		pmulld xmm5, xmm0		; xmm5 = | (px3_a - px3_b) * alpha |
