...
\begin{figure}[H]
  \begin{center}
	\includegraphics[scale=0.55]{imagenes/pixelarC.png}
...
\begin{figure}[H]
  \begin{center}
	\includegraphics[scale=0.55]{imagenes/pixelarExp.png}
...
\begin{figure}[H]
  \begin{center}
	\includegraphics[scale=0.55]{imagenes/rotarC.png}
	\caption{Comparación de los tiempos de ejecución de cada implementación}
	\label{rotar_asmvsc}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
	\includegraphics[scale=0.55]{imagenes/rotarExp.png}
	\caption{Comparación de los tiempos de ejecución}
	\label{rotar_exp}
  \end{center}
\end{figure}
